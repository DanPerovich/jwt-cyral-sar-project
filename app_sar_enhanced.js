...
app.get("/welcome", auth, (req, res) => {
  ...
  // --------------------------
  selectQuery = `/* CyralContext {"user":"${currentUser}","userGroup":"Finance","serviceName":"NodeJWTwPostgresSAR",` +
                 `"attributes":{"someKey":"someValue","checkMe":"${req.user.secret}"}} */ ${selectQuery}`;
